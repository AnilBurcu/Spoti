...
final class PlayerControlsView:UIView {
    ...
    override func layoutSubviews() {
        ...
        nameLabel.frame = CGRect(x: 0, y: 0, width: width, height: 50)
               ...
               forwardButton.frame = CGRect(x: playPauseButton.right+60, y: playPauseButton.top, width: buttonSize, height: buttonSize)
               
               // konumlandırma yaparken istediğimiz gibi olması için butonun kendi size'ını da işin içine katıyoruz yoksa kayıyor
