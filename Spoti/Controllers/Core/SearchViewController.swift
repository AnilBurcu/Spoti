...
class SearchViewController: UIViewController,UISearchResultsUpdating,UISearchBarDelegate, UISearchControllerDelegate {
    ...
    private let collectionView: UICollectionView = UICollectionView(
            ...
            collectionViewLayout: UICollectionViewCompositionalLayout(sectionProvider: { _, _ -> NSCollectionLayoutSection? in
                ...
                let group = NSCollectionLayoutGroup.horizontal(
                    ...
                    subitem: item,
                    count: 2  // yatayda kaç cell olmasını istiyorsak count'a yazıyoruz 1,2,3...
                )
    ...
    func searchBarSearchButtonClicked(_ searchBar: UISearchBar) {
        //Klavye'den enter'a basınca sonuç göstermek için bu fonksiyonda arama yapıyoruz
    ...
    func updateSearchResults(for searchController: UISearchController) {
        ...
        //Klavye'den girilen değere göre anlık olarak sonuç göstermek için bu fonksiyonda arama yapıyoruz
